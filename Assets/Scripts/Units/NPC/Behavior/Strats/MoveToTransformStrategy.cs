...
namespace Arcatech.Units.Behaviour
{
    ...
    public class MoveToTransformStrategy : IBehaviorTreeStrategy
    {
        ...
        public MoveToTransformStrategy(NavMeshAgent nma, Transform target, bool requireAngle = false, float angle = 15f)
        {
            this.nma = nma;
            this.target = target;
